...
export const WhatsAppEnquiryButton = ({ 
  ...
  const baseStyles = "w-full py-2.5 sm:py-3 px-4 rounded-xl font-bold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-sm transition-all duration-200 active:scale-98 cursor-pointer";
  ...
  const variants = {
    ...
    compact: "py-2 px-3 bg-amber-500 hover:bg-amber-600 text-stone-950 text-xs"
  };
