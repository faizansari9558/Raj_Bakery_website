...
export const Footer = ({ onOpenEnquiryModal }) => {
  return (
    <footer className="bg-[#18110D] text-[#E8DCCF] pt-16 pb-12 border-t-4 border-amber-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-stone-800">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link to="/" className="text-stone-300 hover:text-amber-400 transition-colors flex items-center gap-1.5">
                  <span>›</span> Home
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-stone-300 hover:text-amber-400 transition-colors flex items-center gap-1.5">
                  <span>›</span> About Us
                </Link>
              </li>
              <li>
                <Link to="/products" className="text-stone-300 hover:text-amber-400 transition-colors flex items-center gap-1.5">
                  <span>›</span> Bakery Products
                </Link>
              </li>
              <li>
                <Link to="/special-cakes" className="text-stone-300 hover:text-amber-400 transition-colors flex items-center gap-1.5">
                  <span>›</span> Special Cakes & Enquiries
                </Link>
              </li>
              <li>
                <Link to="/find-us" className="text-stone-300 hover:text-amber-400 transition-colors flex items-center gap-1.5">
                  <span>›</span> Find Our Two Locations
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-stone-300 hover:text-amber-400 transition-colors flex items-center gap-1.5">
          ...
          <div>
            ...
            <div className="space-y-4 text-xs sm:text-sm">
              {locations.map((loc) => (
                <div key={loc.id} className="p-3 rounded-lg bg-stone-900/60 border border-stone-800 space-y-1.5">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <button
                ...
                className="w-full py-2.5 px-4 rounded-xl bg-green-600 hover:bg-green-500 text-white font-bold text-xs flex items-center justify-center gap-2 shadow-sm transition-all"
              >
              ...
              <button
                ...
                className="w-full py-2.5 px-4 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-stone-950 font-bold text-xs flex items-center justify-center gap-2 shadow-sm transition-all"
              >
