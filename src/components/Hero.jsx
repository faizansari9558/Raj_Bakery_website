...
import { Cake, MessageCircle, MapPin, Sparkles, ChevronRight, Award, Flame } from 'lucide-react';
import { openWhatsAppEnquiry } from '../utils/whatsapp';

export const Hero = ({ onOpenEnquiryModal }) => {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-stone-950 py-20 lg:py-28">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-stone-950/95 via-stone-950/85 to-stone-950/70"></div>
        <div className="absolute inset-0 bg-radial-gradient from-transparent via-stone-950/40 to-stone-950/90"></div>
      </div>

      {/* Decorative Gold Glows */}
      <div className="absolute top-1/4 left-10 w-72 h-72 rounded-full bg-amber-500/20 blur-[100px] pointer-events-none"></div>
      <div className="absolute bottom-1/4 right-10 w-96 h-96 rounded-full bg-teal-500/15 blur-[120px] pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="inline-flex flex-wrap items-center justify-center lg:justify-start gap-2.5">
              <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-amber-500/20 border border-amber-400/40 text-amber-300 text-xs font-bold uppercase tracking-wider backdrop-blur-md">
                <Sparkles className="w-3.5 h-3.5 text-amber-400" />
                <span>Pune's Fresh Bake Destination</span>
              </span>

              <span className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-stone-900/85 border border-amber-400/40 text-xs font-bold backdrop-blur-md">
                ...
                <span className="inline-flex items-center gap-1.5 text-amber-200">
                  ...
                  <span>Kondhwa: Veg & Non-Veg</span>
                </span>
              </span>
            </div>

            {/* Main Headline */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-6.5xl font-serif font-black text-white tracking-tight leading-[1.1]">
            ...
            {/* Subtitle */}
            <p className="text-base sm:text-lg lg:text-xl text-stone-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-normal">
              Welcome to <span className="text-white font-semibold">Raj Bakery</span> — your destination for fresh daily bakery favourites, handmade cookies, crispy khari, and custom celebration cakes made for every occasion.
            </p>

            {/* Locations Pill */}
            <div className="p-3.5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md max-w-xl mx-auto lg:mx-0 text-xs sm:text-sm text-stone-200 flex items-center gap-3">
            ...
            <div className="pt-2 flex flex-wrap items-center justify-center lg:justify-start gap-3 sm:gap-4">
              ...
              <Link
                to="/products"
                className="px-6 sm:px-8 py-3.5 sm:py-4 rounded-2xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-stone-950 font-bold text-sm sm:text-base flex items-center gap-2 shadow-xl shadow-amber-500/20 active:scale-95 transition-all duration-200"
              >
              ...
              <button
                ...
                className="px-6 sm:px-7 py-3.5 sm:py-4 rounded-2xl bg-green-600 hover:bg-green-500 text-white font-bold text-sm sm:text-base flex items-center gap-2 shadow-lg shadow-green-600/30 active:scale-95 transition-all duration-200 cursor-pointer"
              >
              ...
              <Link
                to="/find-us"
                className="px-5 py-3.5 sm:py-4 rounded-2xl bg-white/10 hover:bg-white/20 text-white font-bold text-sm sm:text-base flex items-center gap-2 backdrop-blur-md border border-white/15 transition-all duration-200"
              >
          ...
          {/* Right Column: Visual Showcase Feature Card with Real Storefront Preview */}
