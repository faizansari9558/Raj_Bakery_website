...
import { openWhatsAppEnquiry, sendDirectPersonWhatsApp } from '../utils/whatsapp';
...
export const Contact = () => {
  ...
  return (
    <div className="space-y-0">
      ...
      {/* 1. Header Banner - Mobile optimized */}
      ...
      <section className="py-10 sm:py-16 lg:py-20 bg-[#FAF5EB] border-b border-amber-900/10">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
          ...
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-[#0F4C47] to-[#165B55] rounded-3xl p-5 sm:p-9 text-white shadow-2xl border-2 border-amber-400/40 relative overflow-hidden">
            {/* Background Glow */}
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-5 sm:gap-6">
              ...
              <div className="space-y-2 text-center md:text-left w-full md:w-auto">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500 text-stone-950 text-[11px] sm:text-xs font-black uppercase tracking-wider shadow-sm">
                ...
                <div className="pt-1 flex items-center justify-center md:justify-start gap-2 text-amber-300 font-mono font-bold text-base sm:text-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3 w-full md:w-auto shrink-0">
                <button
                  ...
                  className="min-h-[48px] w-full sm:w-auto px-6 py-3.5 rounded-xl bg-green-500 hover:bg-green-600 text-white font-bold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-lg shadow-green-950/30 transition-all cursor-pointer active:scale-95"
                >
                ...
                <a
                  ...
                  className="min-h-[48px] w-full sm:w-auto px-6 py-3.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-stone-950 font-bold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-lg shadow-amber-950/20 transition-all active:scale-95 text-center"
                >
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 max-w-5xl mx-auto">
              {contacts.map((contact) => (
                <div 
                  key={contact.id}
                  className={`rounded-3xl p-5 sm:p-6 bg-white border transition-all duration-300 flex flex-col justify-between space-y-4 sm:space-y-5 shadow-sm hover:shadow-xl ${
                ...
                >
                  <div className="space-y-2.5 sm:space-y-3">
                    ...
                    <div>
                      <h4 className="font-serif font-bold text-lg sm:text-xl text-[#2A1810]">
                        {contact.name}
                      </h4>
                    ...
                    <div className="p-2.5 sm:p-3 rounded-xl bg-[#FFFDF7] border border-amber-900/10 flex items-center gap-2">
                      <Phone className="w-4 h-4 text-amber-600 shrink-0" />
                      <span className="font-mono font-bold text-sm sm:text-base text-[#0F4C47]">
                        {contact.phone}
                      </span>
                    </div>
                  </div>

                  {/* Call & WhatsApp Buttons - Minimum 44-48px touch targets */}
                  <div className="grid grid-cols-2 gap-2 pt-2 border-t border-amber-900/10">
                    <a
                      href={`tel:${contact.phone}`}
                      className="min-h-[44px] py-2.5 px-3 rounded-xl bg-stone-100 hover:bg-stone-200 text-[#2A1810] font-bold text-xs flex items-center justify-center gap-1.5 transition-all text-center active:scale-95"
                    >
                    ...
                    <button
                      ...
                      className="min-h-[44px] py-2.5 px-3 rounded-xl bg-green-600 hover:bg-green-700 text-white font-bold text-xs flex items-center justify-center gap-1.5 shadow-xs transition-all cursor-pointer active:scale-95"
                    >
      ...
      <section className="py-10 sm:py-16 lg:py-24 bg-[#FFFDF7]">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-5 sm:space-y-6">
              ...
              <div className="rounded-3xl p-5 sm:p-7 bg-gradient-to-br from-green-700 to-green-800 text-white shadow-lg space-y-3.5 sm:space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-white/20 backdrop-blur-xs flex items-center justify-center text-white shrink-0">
                ...
                <button
                  onClick={() => openWhatsAppEnquiry({ type: 'general' })}
                  className="min-h-[48px] w-full py-3 px-4 rounded-xl bg-white text-green-800 font-bold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-md hover:bg-green-50 active:scale-98 transition-all cursor-pointer"
                >
              ...
              <div className="rounded-3xl p-5 sm:p-7 bg-[#FAF5EB] border border-amber-900/10 space-y-4 sm:space-y-5">
                <h3 className="font-serif font-bold text-base sm:text-lg text-[#2A1810] flex items-center gap-2">
                  <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-amber-600" />
                  <span>Bakery Locations</span>
                </h3>

                {locations.map((loc) => (
                  <div key={loc.id} className="p-3.5 sm:p-4 rounded-2xl bg-white border border-amber-900/10 space-y-2">
                    <div className="flex items-center justify-between">
                      <h4 className="font-bold text-xs sm:text-sm text-[#0F4C47]">{loc.name}</h4>
