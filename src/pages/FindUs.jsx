    ...
    <div className="space-y-0">
      ...
      <section className="py-10 sm:py-16 lg:py-24 bg-[#FFFDF7]">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 sm:mt-16 max-w-3xl mx-auto p-5 sm:p-8 rounded-3xl bg-[#FAF5EB] border border-amber-900/10 text-center space-y-3 sm:space-y-4">
            ...
            <div className="pt-1 sm:pt-2">
              <button
                ...
                className="min-h-[48px] inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-green-600 hover:bg-green-500 text-white font-bold text-xs sm:text-sm shadow-md transition-all cursor-pointer active:scale-95"
              >
